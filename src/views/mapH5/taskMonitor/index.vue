...
<template>
  <div id="dispatchMonitorMap">
    ...
    <div class="search-bar" style="width: 100%; margin: 0 auto;">
      ...
      <Select v-show="searchType==1" clearable filterable @on-change="onTruckSelectChange" v-model="simId" size="large" style="width: 100%; margin-left: -50%; margin-top: -85px; box-shadow: 3px 3px 3px #aaa;">
      ...
      <Button 
        ...
        size="large">{{mapType == 'NORMAL_MAP' ? '平面图' : '卫星图'}}
      </Button>
      <!-- <Button 
        @click="changeMapType"
        style="background-color: #fff;margin-left:8px;box-shadow: 3px 3px 3px #aaa;" 
        type="ghost" 
        icon="qr-scanner"
        size="large">拉框查找
      </Button>
