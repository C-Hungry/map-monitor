              ...
              <a 
                style="
                 ...
                 href="${location.href.substring(0, location.href.indexOf('#')) + 
                  '/#/mapH5/playback?simId=' + item.SimId + 
                  '&startTime=' + (item.dispatchTime ? item.dispatchTime : this.$utils.formateDate(new Date(new Date().getTime() - 60 * 60 * 1000), "yyyy-MM-dd HH:mm:ss")) + 
                  '&endTime=' + this.$utils.formateDate(new Date(), "yyyy-MM-dd HH:mm:ss")}">
                 轨迹回放
              </a>
            </div>
          </div>`;
          ...
          <div>
            <a 
              style="
                ...
                border-radius: 3px;"
                href="${location.href.substring(0, location.href.indexOf('#')) + 
                  '/#/mapH5/playback?simId=' + point.SimId + 
                  '&startTime=' + (point.dispatchTime ? point.dispatchTime : this.$utils.formateDate(new Date(new Date().getTime() - 60 * 60 * 1000), "yyyy-MM-dd HH:mm:ss")) + 
                  '&endTime=' + this.$utils.formateDate(new Date(), "yyyy-MM-dd HH:mm:ss")}">
                轨迹回放
            </a>
          </div>
